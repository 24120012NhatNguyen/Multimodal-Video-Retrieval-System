...
function ImageList({
  ...
  return (
    ...
    >
      ...
      {answer && (
        <div
          className={`rounded-md px-2 py-1 absolute bottom-0 left-0 bg-white/80 text-sm text-slate-900 font-bold max-w-full overflow-hidden text-ellipsis whitespace-nowrap`}
        >
          {answer}
        </div>
      )}
